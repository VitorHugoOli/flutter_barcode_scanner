...
class BarcodeScannerViewController: UIViewController {
    ...
    func drawUIOverlays(withCompletion processCompletionCallback: () -> Void){
        ...
        let transparentPath = UIBezierPath(rect: CGRect(x: xCor/1.7, y: yCor*2, width: screenSize.height*1.7, height: screenSize.width/6))
        ...
        let scanRect = CGRect(x: xCor, y: yCor, width: screenHeight, height: screenHeight)
    ...
    private func drawLine() {
        ...
        scanlineRect = CGRect(x: xCor/1.7, y: yCor,width: screenSize.height*1.7, height: 2)
      

        scanlineStopY = yCor*3.8
    }
